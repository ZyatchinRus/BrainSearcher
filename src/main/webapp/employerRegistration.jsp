...
<div class="form1">
    ...
    <div class ="input-form">
        <input required type = "date" name = "date" placeholder = "Дата Рождения">
    </div>
    <div class ="input-form">
    ...
    <div class ="input-form">
        <input required type = "text" name="work" placeholder = "Место работы">
    </div>
        <input hidden name="formaction" type="text" value="regform">
    <div>
